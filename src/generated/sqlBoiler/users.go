...
var UserWhere = struct {
	...
	Patronymic: whereHelpernull_String{field: "\"users\".\"patronymic\""},
	Phone:      whereHelpernull_String{field: "\"users\".\"phone\""},
	Email:      whereHelpernull_String{field: "\"users\".\"email\""},
	IsEnabled:  whereHelpernull_Bool{field: "\"users\".\"is_enabled\""},
	PhotoURL:   whereHelpernull_String{field: "\"users\".\"photo_url\""},
...
var (
	userAllColumns            = []string{"id", "first_name", "last_name", "patronymic", "phone", "email", "is_enabled", "photo_url", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"id", "created_at", "updated_at"}
	userColumnsWithDefault    = []string{"first_name", "last_name", "patronymic", "phone", "email", "is_enabled", "photo_url", "deleted_at"}
